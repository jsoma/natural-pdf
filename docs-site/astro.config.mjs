...
export default defineConfig({
      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: "5. Grids", slug: "learn/05-grids" },
            { label: "6. Putting it together", slug: "learn/06-putting-it-together" },
          ],
        },
        {
          label: "Concepts",
  ...
  redirects: {
    ...
    "/cookbook/": "/natural-pdf/learn/06-putting-it-together/",
    "/cookbook/batch-processing/": "/natural-pdf/learn/06-putting-it-together/",
    "/cookbook/one-page-one-row/": "/natural-pdf/learn/06-putting-it-together/",
    "/cookbook/finding-sections/": "/natural-pdf/learn/06-putting-it-together/",
    ...
    "/cookbook/guides/": "/natural-pdf/learn/05-grids/",
    ...
    "/loops-and-groups/": "/natural-pdf/learn/06-putting-it-together/",
