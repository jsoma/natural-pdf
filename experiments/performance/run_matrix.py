...
CANDIDATES = [
    ...
    Candidate(
        "selector_shortcuts",
        "find_contains_first",
        PATCH_ROOT / "selector_shortcuts" / "find_contains_first" / "patch.py",
        "real:01-practice,real:guides-expenses-sample,real:Atlanta_Public_Schools_GA_sample,real:0500000US42001,real:policy-lines,micro:find-anchors:01-practice,micro:find-anchors:atlanta,micro:find-anchors:policy-lines,micro:region-navigation:m27",
    ),
    Candidate(
        "selector_shortcuts",
        "find_aggregate_first",
        PATCH_ROOT / "selector_shortcuts" / "find_aggregate_first" / "patch.py",
        "real:01-practice,real:guides-expenses-sample,real:Atlanta_Public_Schools_GA_sample,real:0500000US42001,real:policy-lines,micro:find-anchors:01-practice,micro:find-anchors:atlanta,micro:find-anchors:policy-lines,micro:region-navigation:m27",
    ),
    Candidate(
        "selector_shortcuts",
        "find_combined_first",
        PATCH_ROOT / "selector_shortcuts" / "find_combined_first" / "patch.py",
        "real:01-practice,real:guides-expenses-sample,real:Atlanta_Public_Schools_GA_sample,real:0500000US42001,real:policy-lines,micro:find-anchors:01-practice,micro:find-anchors:atlanta,micro:find-anchors:policy-lines,micro:region-navigation:m27",
    ),
    Candidate(
        "region_first",
        "typed_pool",
        PATCH_ROOT / "region_first" / "typed_pool" / "patch.py",
        "real:01-practice,real:Atlanta_Public_Schools_GA_sample,real:hebrew-table,real:policy-lines,micro:region-navigation:m27,micro:guide-table:01-practice",
    ),
    Candidate(
        "region_first",
        "word_pool_only",
        PATCH_ROOT / "region_first" / "word_pool_only" / "patch.py",
        "real:01-practice,real:Atlanta_Public_Schools_GA_sample,real:hebrew-table,real:policy-lines,micro:region-navigation:m27,micro:guide-table:01-practice",
    ),
    Candidate(
        "region_first",
        "no_exclusion_typed_pool",
        PATCH_ROOT / "region_first" / "no_exclusion_typed_pool" / "patch.py",
        "real:01-practice,real:Atlanta_Public_Schools_GA_sample,real:hebrew-table,real:policy-lines,micro:region-navigation:m27,micro:guide-table:01-practice",
    ),
    Candidate(
        "wildcard_shortcuts",
        "no_chars_upper_bound",
        PATCH_ROOT / "wildcard_shortcuts" / "no_chars_upper_bound" / "patch.py",
        "real:01-practice,real:policy-lines,micro:get-elements:m27,micro:get-elements:tiny-text,micro:find-all-any:m27,micro:page-materialize:m27",
    ),
    Candidate(
        "guide_table",
        "skip_alt_text_scan",
    ...
    Candidate(
        "guide_lines",
        "direct_both_axis",
        PATCH_ROOT / "guide_lines" / "direct_both_axis" / "patch.py",
        "micro:guide-lines-vector-both:01-practice,micro:guide-lines-vector-both:policy-lines,micro:guide-lines-pixels-both:01-practice,micro:guide-table:01-practice,real:guides-expenses-sample",
    ),
    Candidate(
        "guide_lines",
        "pixel_both_axis_detect_cache",
        PATCH_ROOT / "guide_lines" / "pixel_both_axis_detect_cache" / "patch.py",
        "micro:guide-lines-pixels-both:01-practice,micro:guide-table:01-practice,real:guides-expenses-sample",
    ),
    Candidate(
        "guide_lines",
        "pixel_axis_specific",
        PATCH_ROOT / "guide_lines" / "pixel_axis_specific" / "patch.py",
        "micro:guide-lines-pixels-horizontal:01-practice,micro:guide-lines-pixels-vertical:01-practice,micro:guide-table:01-practice,real:guides-expenses-sample",
    ),
    Candidate(
        "guide_lines",
        "vector_numpy_classify",
        PATCH_ROOT / "guide_lines" / "vector_numpy_classify" / "patch.py",
        "micro:guide-lines-vector-both:01-practice,micro:guide-lines-vector-both:policy-lines,micro:guide-table:01-practice,real:policy-lines",
    ),
    Candidate(
        "guide_lines",
        "vector_single_pass_cache",
        PATCH_ROOT / "guide_lines" / "vector_single_pass_cache" / "patch.py",
        "micro:guide-lines-vector-both:01-practice,micro:guide-lines-vector-both:policy-lines,micro:guide-table:01-practice,real:policy-lines",
    ),
    Candidate(
        "pixel_detection",
        "uint8_profile_pipeline",
        PATCH_ROOT / "pixel_detection" / "uint8_profile_pipeline" / "patch.py",
        "micro:guide-lines-pixels-both:01-practice,micro:guide-lines-pixels-horizontal:01-practice,micro:guide-lines-pixels-vertical:01-practice,micro:guide-table:01-practice,real:guides-expenses-sample",
    ),
    Candidate(
        "pixel_detection",
        "cv2_adaptive_pipeline",
        PATCH_ROOT / "pixel_detection" / "cv2_adaptive_pipeline" / "patch.py",
        "micro:guide-lines-pixels-both:01-practice,micro:guide-lines-pixels-horizontal:01-practice,micro:guide-lines-pixels-vertical:01-practice,micro:guide-table:01-practice,real:guides-expenses-sample",
    ),
    Candidate(
        "pixel_detection",
        "fast_topk_peaks",
        PATCH_ROOT / "pixel_detection" / "fast_topk_peaks" / "patch.py",
        "micro:guide-lines-pixels-both:01-practice,micro:guide-lines-pixels-horizontal:01-practice,micro:guide-lines-pixels-vertical:01-practice,micro:guide-table:01-practice,real:guides-expenses-sample",
    ),
    Candidate(
        "pixel_detection",
        "resolution_150",
        PATCH_ROOT / "pixel_detection" / "resolution_150" / "patch.py",
        "micro:guide-lines-pixels-both:01-practice,micro:guide-lines-pixels-horizontal:01-practice,micro:guide-lines-pixels-vertical:01-practice,micro:guide-table:01-practice,real:guides-expenses-sample",
    ),
    Candidate(
        "pixel_detection",
        "resolution_120",
        PATCH_ROOT / "pixel_detection" / "resolution_120" / "patch.py",
        "micro:guide-lines-pixels-both:01-practice,micro:guide-lines-pixels-horizontal:01-practice,micro:guide-lines-pixels-vertical:01-practice,micro:guide-table:01-practice,real:guides-expenses-sample",
    ),
    Candidate(
        "rendering",
