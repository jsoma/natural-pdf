...
class DirectionalMixin:
    ...
    def _direction(
        ...
        **kwargs,
        ...
        Returns:
            Region object
        """
        from natural_pdf.elements._directional import compute_direction
    ...
    def _direction_multipage(
        ...
        **kwargs,
        ...
        """
        from natural_pdf.elements._directional import compute_direction_multipage

        return compute_direction_multipage(
            self,
            direction=direction,
            size=size,
            cross_size=cross_size,
